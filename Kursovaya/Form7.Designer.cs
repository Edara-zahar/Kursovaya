...
namespace Kursovaya
{
    partial class Form7
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.редактироватьОтчётToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            ...
            this.редактироватьОтчётToolStripMenuItem});
            ...
            // 
            // редактироватьОтчётToolStripMenuItem
            // 
            this.редактироватьОтчётToolStripMenuItem.Name = "редактироватьОтчётToolStripMenuItem";
            this.редактироватьОтчётToolStripMenuItem.Size = new System.Drawing.Size(132, 20);
            this.редактироватьОтчётToolStripMenuItem.Text = "Редактировать отчёт";
            this.редактироватьОтчётToolStripMenuItem.Click += new System.EventHandler(this.редактироватьОтчётToolStripMenuItem_Click);
            // 
            // Form7
            // 
        ...
        private System.Windows.Forms.ToolStripMenuItem редактироватьОтчётToolStripMenuItem;
    }
}