...
namespace Kursovaya
{
    public partial class Form11 : MetroFramework.Forms.MetroForm
    {
        ...
        {
            //string increment = "ALTER TABLE расписание ADD IDENTITY(Код_Товара);";
            string SqlText;

            //Сформировать SQL-Строку
            SqlText = "INSERT INTO расписание (Сотрудник,Дата,Время) VALUES(";
        ...
        private void metroButton2_Click(object sender, EventArgs e)
        {
            ...
            int index, n;
            string Id_Source;
            string SqlText = "DELETE FROM расписание WHERE расписание.id = ";
        ...
        private void metroButton3_Click(object sender, EventArgs e)
        {
            ...
            int index, n;
            string SqlText = "UPDATE расписание SET ";
            string Id_Source, sotrudnik, data, time;
            n = dataGridView1.Rows.Count;
            if (n == 1) return;
            index = dataGridView1.CurrentRow.Index;
            Id_Source = dataGridView1[0, index].Value.ToString();
            sotrudnik = metroTextBox1.Text;
            data = metroTextBox2.Text;
            time = metroTextBox3.Text;
            SqlText += "Сотрудник = \'" + sotrudnik + "\',Дата = '" + data + "\',Время = '" + time + "\'";
            SqlText += "WHERE расписание.id = " + Id_Source;
            try
            {
                MyExecuteNonQuery(SqlText);
            }
