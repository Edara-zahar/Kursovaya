...
namespace Kursovaya
{
    public partial class Form13 : MetroFramework.Forms.MetroForm
    {
        ...
        {
            //string increment = "ALTER TABLE зарплата ADD IDENTITY(Код_Товара);";
            string SqlText;

            //Сформировать SQL-Строку
            SqlText = "INSERT INTO зарплата (ФИО,Начислено,Премия,Дата,Штраф) VALUES(";
        ...
        private void metroButton2_Click(object sender, EventArgs e)
        {
            ...
            int index, n;
            string Id_Source;
            string SqlText = "DELETE FROM зарплата WHERE зарплата.id = ";
        ...
        private void metroButton3_Click(object sender, EventArgs e)
        {
            ...
            int index, n;
            string SqlText = "UPDATE зарплата SET ";
            string Id_Source, FIO, nachisleno, premia, data, shtraf;
            n = dataGridView1.Rows.Count;
            if (n == 1) return;
            index = dataGridView1.CurrentRow.Index;
            Id_Source = dataGridView1[0, index].Value.ToString();
            FIO = metroTextBox1.Text;
            nachisleno = metroTextBox2.Text;
            premia = metroTextBox3.Text;
            data = metroTextBox4.Text;
            shtraf = metroTextBox5.Text;
            SqlText += "ФИО = \'" + FIO + "\',Начислено = '" + nachisleno + "\',Премия = '" + premia + "\',Дата = '" + data + "\',Штраф = '" + shtraf + "\'";
            SqlText += "WHERE зарплата.id = " + Id_Source;
            try
            {
                MyExecuteNonQuery(SqlText);
            }
